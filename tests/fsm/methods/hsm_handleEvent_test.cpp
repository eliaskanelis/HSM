...
/* Initial state */
state_t firstState = {.itsInitialState = NULL,
                      .itsParentState  = NULL,
                      .onEntry         = NULL,
                      .during          = NULL,
                      .onExit          = NULL,
                      .itsTransition =
                          (hsm_transition_t[]){{NULL, NULL, &secondState}},
                      .itsTransitionNum = 1};

/* Next state */
state_t secondState = {.itsInitialState = NULL,
                       .itsParentState  = NULL,
                       .onEntry         = NULL,
                       .during          = NULL,
                       .onExit          = NULL,
                       .itsTransition =
                           (hsm_transition_t[]){{NULL, NULL, &firstState}},
                       .itsTransitionNum = 1};

static state_t* stateList[] = {&firstState, &secondState};
