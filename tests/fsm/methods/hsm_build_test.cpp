...
state_t parentState = {.itsInitialState  = NULL,
                       .itsParentState   = NULL,
                       .onEntry          = NULL,
                       .during           = NULL,
                       .onExit           = NULL,
...
/* Initial state */
state_t childState = {.itsInitialState  = NULL,
...
static state_t* stateList[] = {&parentState, &childState};
...
TEST(hsm_build,
     Should_InitializeInvalidHsmHandle_When_NoNumberOfStateListGiven)
{
	/* Build hsm */
...
TEST(
    hsm_build,
    Should_InitializeInvalidHsmHandle_When_NoStateListAndNoNumberOfStateListGiven)
{
	/* Build hsm */
