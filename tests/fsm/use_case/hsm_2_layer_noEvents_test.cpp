...
state_t topA = {.itsInitialState  = &subA1,
                .itsParentState   = NULL,
                .onEntry          = NULL,
                .during           = NULL,
                .onExit           = NULL,
...
state_t subA1 = {.itsInitialState = NULL,
                 .itsParentState  = &topA,
                 .onEntry         = NULL,
                 .during          = NULL,
                 .onExit          = NULL,
                 .itsTransition   = (hsm_transition_t[]){{NULL, NULL, &subA2}},
                 .itsTransitionNum = 1};

state_t subA2 = {.itsInitialState = NULL,
                 .itsParentState  = &topA,
                 .onEntry         = NULL,
                 .during          = NULL,
                 .onExit          = NULL,
                 .itsTransition   = (hsm_transition_t[]){{NULL, NULL, &subB1}},
                 .itsTransitionNum = 0};

state_t topB = {.itsInitialState  = &subB1,
                .itsParentState   = NULL,
                .onEntry          = NULL,
                .during           = NULL,
                .onExit           = NULL,
...
state_t subB1 = {.itsInitialState = NULL,
                 .itsParentState  = &topB,
                 .onEntry         = NULL,
                 .during          = NULL,
                 .onExit          = NULL,
                 .itsTransition   = (hsm_transition_t[]){{NULL, NULL, &subA1}},
                 .itsTransitionNum = 1};
...
static void CHECK_HSM(hsm_t*        me,
                      state_t*      fromState,
                      hsm_st_mode_t fromMode,
                      state_t*      toState,
                      hsm_st_mode_t toMode)
{
	/* From */
