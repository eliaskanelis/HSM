...
WorkspacePath          :=G:/Work/Projects/Beehive/Mk2/PC/HSM/prj
ProjectPath            :=G:/Work/Projects/Beehive/Mk2/PC/HSM/prj
...
Objects0=$(IntermediateDirectory)/up_src_main.c$(ObjectSuffix) $(IntermediateDirectory)/up_src_console.c$(ObjectSuffix) $(IntermediateDirectory)/up_src_hsm.c$(ObjectSuffix) $(IntermediateDirectory)/up_src_newSys.c$(ObjectSuffix) $(IntermediateDirectory)/up_src_oldSys.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/up_src_main.c$(ObjectSuffix): ../src/main.c $(IntermediateDirectory)/up_src_main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "G:/Work/Projects/Beehive/Mk2/PC/HSM/src/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_console.c$(ObjectSuffix): ../src/console.c $(IntermediateDirectory)/up_src_console.c$(DependSuffix)
	$(CC) $(SourceSwitch) "G:/Work/Projects/Beehive/Mk2/PC/HSM/src/console.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_console.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_hsm.c$(ObjectSuffix): ../src/hsm.c $(IntermediateDirectory)/up_src_hsm.c$(DependSuffix)
	$(CC) $(SourceSwitch) "G:/Work/Projects/Beehive/Mk2/PC/HSM/src/hsm.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_hsm.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_newSys.c$(ObjectSuffix): ../src/newSys.c $(IntermediateDirectory)/up_src_newSys.c$(DependSuffix)
	$(CC) $(SourceSwitch) "G:/Work/Projects/Beehive/Mk2/PC/HSM/src/newSys.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_newSys.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_oldSys.c$(ObjectSuffix): ../src/oldSys.c $(IntermediateDirectory)/up_src_oldSys.c$(DependSuffix)
	$(CC) $(SourceSwitch) "G:/Work/Projects/Beehive/Mk2/PC/HSM/src/oldSys.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_oldSys.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_src_oldSys.c$(DependSuffix): ../src/oldSys.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_src_oldSys.c$(ObjectSuffix) -MF$(IntermediateDirectory)/up_src_oldSys.c$(DependSuffix) -MM ../src/oldSys.c

$(IntermediateDirectory)/up_src_oldSys.c$(PreprocessSuffix): ../src/oldSys.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_src_oldSys.c$(PreprocessSuffix) ../src/oldSys.c
